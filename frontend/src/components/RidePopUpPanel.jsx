  ...
  return (
    <div className="w-screen">
      <div className="text-center">
        <i onClick={()=>[props.setRidePopUpPanel(false)]} className="ri-arrow-down-wide-fill text-3xl text-gray-400"></i>
      </div>
      ...
      <button
        ...
        className="w-48 mx-auto block mt-6 py-2 bg-green-600 rounded-xl text-white font-bold text-xl"
      >
        Accept
      </button>
      ...
      <button
        ...
        className="w-48 mx-auto block mt-4 py-2 bg-gray-400 rounded-xl text-white font-bold text-xl"
      >
        Ignore
      </button>
    </div>
