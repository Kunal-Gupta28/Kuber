  ...
  const handleImageUpload = async (e) => {
    ...
    try {
      ...
      const response = await axios.post(
        `${import.meta.env.VITE_BASE_URL}/users/upload-profile-image`,
        formData,
        {
          headers: {
            ...
            <div className="absolute -bottom-16 sm:-bottom-20 left-4 sm:left-8">
              <div className="relative group">
                ...
                <button
                  ...
                  className="absolute bottom-0 right-4 w-8 h-8 flex items-center justify-center rounded-full bg-blue-500 text-white shadow-lg hover:bg-blue-600 transition-all duration-200 border-2 border-white dark:border-gray-800 hover:scale-110 hover:shadow-xl"
          ...
          <div className="pt-24 sm:pt-28 pb-6 sm:pb-8 px-4 sm:px-8">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 sm:gap-8">
              ...
              <div className="space-y-6">
                <div className="bg-gray-50 dark:bg-gray-700/50 p-6 sm:p-8 rounded-2xl shadow-sm hover:shadow-md transition-all duration-300 transform hover:-translate-y-1">
                ...
                <div className="bg-gray-50 dark:bg-gray-700/50 p-6 sm:p-8 rounded-2xl shadow-sm hover:shadow-md transition-all duration-300 transform hover:-translate-y-1">
                  ...
                  <div className="space-y-4">
                    ...
                    <div>
                      ...
                      <p className="text-gray-900 dark:text-white font-medium flex items-center">
                        <i className="ri-bank-card-line mr-2 text-blue-500"></i>
                        {user?.preferredPayment || 'Credit Card'}
                      </p>
                    </div>
                    {/* Saved Addresses */}
                    <div>
