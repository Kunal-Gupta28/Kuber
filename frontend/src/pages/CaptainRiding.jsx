  ...
  return (
    <main className="h-[100dvh] w-full flex flex-col overflow-hidden dark:bg-gray-900 text-black dark:text-white relative">
      ...
      <header className="fixed top-0 left-0 right-0 z-50 flex justify-between items-center p-4 bg-white/80 dark:bg-gray-900/80 backdrop-blur-sm shadow-sm">
        <h1 className="text-xl sm:text-2xl font-bold text-gray-800 dark:text-white bg-gradient-to-r from-yellow-400 to-yellow-500 dark:from-yellow-500 dark:to-yellow-600 rounded-xl p-2 px-4 transition duration-300 hover:scale-105 hover:shadow-lg">
          Kubik
        </h1>
      </header>
      ...
      <footer className="h-[20%] 4k:h-[11%] w-full bg-gradient-to-b from-yellow-400 to-yellow-500 dark:from-yellow-500 dark:to-yellow-600 p-4 sm:p-5 fixed bottom-0 flex flex-col sm:flex-row justify-center items-center gap-4 sm:gap-6 z-40 shadow-inner rounded-t-3xl border-t border-yellow-300 dark:border-yellow-600">
        <div className="w-full flex justify-evenly gap-4 sm:gap-6">
          <div className="h-14 sm:h-16 w-full sm:w-48 bg-gradient-to-r from-green-600 to-green-700 dark:from-green-700 dark:to-green-800 rounded-xl text-lg sm:text-xl font-semibold text-white flex justify-center items-center shadow-lg transition duration-300">
          ...
          <button
            ...
            className="h-14 sm:h-16 w-full sm:w-48 bg-gradient-to-r from-green-600 to-green-700 dark:from-green-700 dark:to-green-800 rounded-xl text-lg sm:text-xl font-semibold text-white shadow-lg hover:shadow-xl transition duration-300 active:scale-95"
          >
            Finish Ride
          </button>
        </div>
          ...
          <div className="p-6 sm:p-8">
            ...
            <div className="flex flex-col sm:flex-row justify-center gap-4">
              <button
                ...
                className="h-14 sm:h-16 w-full sm:w-48 bg-gradient-to-r from-green-600 to-green-700 dark:from-green-700 dark:to-green-800 hover:from-green-700 hover:to-green-800 dark:hover:from-green-800 dark:hover:to-green-900 text-white rounded-xl font-semibold text-lg transition duration-300 hover:shadow-xl active:scale-95"
              >
                Confirm
              </button>
              <button
                onClick={hideFinishRide}
                className="h-14 sm:h-16 w-full sm:w-48 bg-gradient-to-r from-gray-900 to-black dark:from-gray-800 dark:to-gray-900 hover:from-gray-800 hover:to-gray-900 dark:hover:from-gray-700 dark:hover:to-gray-800 text-white rounded-xl font-semibold text-lg transition duration-300 hover:shadow-xl active:scale-95"
              >
                Cancel
              </button>
            </div>
